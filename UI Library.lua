...
function Library.Render(settings)
    ...
    local Title = "<font color=\"rgb(129, 145, 255)\">" .. settings.Title .."</font>"
    ...
    asdasd = false 
            album.MouseButton1Click:Connect(function()
                    ...
                    if asdasd then
                        ...
                        Close.MouseButton1Click:Connect(function()
                            if asdasd and DebugWindow.BackgroundTransparency == 0 then
                                Base:Destroy()
                            end
                        end)
                        else
        ...
        function Tabs:Tab(settings)
            ...
            function Elements:Label(settings)
                ...
                local C = settings.Color or Color3.fromRGB(235, 235, 235)
                local Trans = settings.Transparency or 0 
